        ...
        <form>
            ...
            <button
                ...
                onClick={() => {
                    const newRoom = {
                        id: Date.now(),
                        images: Object.values(images).filter(Boolean).map(file => URL.createObjectURL(file)),
                        pricePerNight: inputs.pricePerNight,
                        roomType: inputs.roomType,
                        amenities: Object.keys(inputs.amenities).filter(key => inputs.amenities[key]),
                        hotel: {
                    ...
                    localStorage.setItem('rooms', JSON.stringify([newRoom, ...existingRooms]));
