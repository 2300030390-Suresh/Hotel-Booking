        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                ...
                <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                    {room?.images.length > 1 && room.images.map((image, index) => (
                        <img
                            ...
                            src={image}
                            alt="Room Image"
                            className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && 'outline-orange-500 outline-3'}`}
                        />
                    ))}
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flrx-wrap items-center mt-3 mb-6 gap-4'>
            ...
            <div className='max-m-3x1 border-y border-gray-300 my-15 py-10 text-gray-500'>
