        ...
        <Link to={`/rooms/${room.id}`} onClick={() => scrollTo(0, 0)} key={room.id}
            ...
            <div className='p-4 pt-5'>
                <div className='flex items-center justify-between'>
                    <p className='font-palyfair text-x1 font-medium text-gray-800'> {room.hotel.name}</p>
                ...
                <div className='flex items-center justify-between mt-4'>
                    <p><span className='text-x1 text-gray-800'>${room.pricePerNight}</span>${room.pricePerNight}/night</p>
